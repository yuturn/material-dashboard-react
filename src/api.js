...
export const apiCreateUser = (data) => auth_except(baseRequest.post('/users/create-user', data, {
  headers:
  {
    'accept': 'application/json',
...
export const apiPendingApprovalUser = (data) => auth_except(baseRequest.post('/users/pending-approval-user', data, {
  headers:
  {
    'accept': 'application/json',
    'Content-Type': 'application/json'
